...
<sup>1: Last Updated 1/13/25</sup>
...
| ---------------------------------------------------------- | -------------------------- | --------------------------------------------------- | ----------------------------------------------------- | ------------------------------------------------------ | ---------------------------------------------------- | ----------------------------------------------------------------------------------- |
| [zukijourney](https://discord.com/invite/Y4J6XXnmQ6)       | 6,398                      | ✅ Allowed   | ✅ [Here](https://github.com/zukixa/zukijourney-api)  | [Our Team](https://github.com/orgs/zukijourney/people) | [Models](https://docs.zukijourney.com/models)        | Largest & oldest GPT-4 API still running. Offers other popular AI-related bots too. |
| [Shard](https://discord.gg/rY85WpENSt)       | 1,295                        | ❌ Only open-source models | ❌               | [Puzzy](https://github.com/Puzzy124)      | [Models](http://api.shard-ai.xyz/v1/models)     | Known for its edgy reputation but offers consistent, standard services now.                                        |
| [FresedGPT](https://discord.gg/JecEC5my4T)                 | 1,137                        | ❌ Forbidden                                        | ❌                                                    | [Fresed](https://github.com/qazplmqaz)                 | [Models](https://fresedgpt.space/v1/models)          | Small API with high-quality performance maintained by a committed dev.              |
...
| **Service**                                  | **# of Users**<sup>1</sup> | **NSFW/RP Ok?**            | **Open Source?** | **Owner(s)**                              | **Models**                                      | **Other Notes**                                                                                                    |
| -------------------------------------------- | -------------------------- | -------------------------- | ---------------- | ----------------------------------------- | ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| [NagaAI](https://discord.gg/JxRBXBhabu)      | 3,330                     | ❌ Forbidden               | ❌               | [ZentixUA](https://github.com/ZentixUA)   | [Models](https://api.naga.ac/v1/models)         | Honorary successor to ChimeraGPT, the largest g4f API in history (16k users). |
| [WebraftAI](https://discord.gg/ncaagQjhQ8) | 1,242                      | ❌ Forbidden    | ❌                                                    | [ds_gamer](https://github.com/ds-gamer) | [Models](https://api.webraft.in/freeapi/models) |Recovered from 5-month downtime due to the owner's health issues. Some oddities in current service.                  |
| [ZanityAI](https://discord.gg/4DRjqaFkhd)    | 930                        | 💰 Paid models only        | ❌               | [Voidii](https://github.com/void6670)     | [Models](https://api.zanity.xyz/v1/models)      | Solid roleplay-friendly API with however questionable dev behavior. Good but Inconsistent at times.                                     |
...
| **Service**                                | **# of Users**<sup>1</sup> | **NSFW/RP Ok?** | **Open Source?**                                      | **Owner(s)**                            | **Models**                                      | **Other Notes**                                                                       |
| ------------------------------------------ | -------------------------- | --------------- | ----------------------------------------------------- | --------------------------------------- | ----------------------------------------------- | ------------------------------------------------------------------------------------- |
| [XET](https://discord.com/invite/hmMBe8YyJ4) | 1,139                      | ✅ Allowed                  | ✅ [Here](https://github.com/AlphastT101/luminaryai)               | [alphast101](https://alphast101.netlify.app) | [Models](http://api.xet.one/v1/models)                  | [Conducted a coordinated raid on another AI API server.](https://rentry.co/progptraid)                                    |
| [HelixMind](https://discord.gg/UHwb4A8HkE) | 1,044                        | ❌ Forbidden    | ❌                                                    | [faer1x](https://github.com/faer1x)     | [Models](https://helixmind.online/v1/models)    | Subscription-based service that 'just about' fits into the g4f principles definition with its free tier. |
...
| **Service**                                  | **# of Users**<sup>1</sup> | **NSFW/RP Ok?**             | **Open Source?** | **Owner(s)**                                 | **Models**                                              | **Other Notes**                                                                                                           |
| -------------------------------------------- | -------------------------- | --------------------------- | ---------------- | -------------------------------------------- | ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| [ClashAI](https://discord.gg/free-ai) | 2,421 | ❌ Forbidden                | ❌               | [Sian](https://github.com/invalidsian)    | [Models](https://api.clashai.eu/v1/models)                | API that finally came back after 'teasing' its re-release for multiple months.                               |
| [Skailar](https://discord.gg/ka9tkU9UNz)   | 457                        | ❌ Forbidden    | ✅ [Here](https://github.com/zukijourney/example-api) | [Aquadraws](https://test.skailar.it/)   | [Models](https://test.skailar.it/v1/models)     | One of the oldest APIs. Stability and maintainer involvement are questionable.        |
| [HXA/HeckerAI](https://discord.gg/CzTvEbUaHS)    | 295                        | ❌ Forbidden                | ❌               | [Hecker](https://github.com/LiveGamer101)    | [Models](https://heckerai.com/v1/models)                | API with ongoing stability issues due to inconsistent maintainer commitment and mental health.                                |
...
| ---------------------------------------------- | -------------------------- | --------------- | ---------------- | ----------------------------------------- | --------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [AnyAI](https://discord.gg/anyai)              | 1,822                      | ✅ Allowed      | ❌               | [Meow18838](https://github.com/meow18838) | [Models](https://api.airforce/models)         | Most influential person in the server is [a terrible being.](https://paste.gg/p/anonymous/6929f0449b8d44e981e90c7155df2126)                                                       |
| [CablyAI](https://discord.gg/SvudTHhCxH)       | 1,383                        | ✅ Allowed      | ❌               | [CablyAI](https://github.com/CablyAI)     | [Models](https:/cablyai.com/v1/models)        | Most influential person in the server is [a terrible being.](https://paste.gg/p/anonymous/6929f0449b8d44e981e90c7155df2126)                                                       |
| [ShadowJourney](https://discord.gg/yB2YZJUA3F) | 709                        | ❌ Forbidden    | ❌               | [ichatei](https://shadowjourney.xyz)      | [Models](https://shadowjourney.xyz/v1/models) | [Admitted privately to DDOS competition.](https://files.catbox.moe/4wu7t2.png) Very weird owner. Stability is often questioned due to supposed fake models. Use at your own risk. |
...
| ------------------------------------------------------------- | ---------------------- | ------------------------------------------------------------------------------------------------------ | ----------------------------------------------- |
| [g4f.ai](https://discord.gg/zPX6QWm5fg)                       | 12,837                  | The OG server. Hub of the github [repository](https://github.com/xtekky/gpt4free) that started it all. | Inactive                                        |
...
> [!IMPORTANT]  
> Data given without warranty of any kind. **As of December 2024.**
