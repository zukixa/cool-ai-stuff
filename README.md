...
| [XET](https://discord.com/invite/hmMBe8YyJ4) | 1,162                      | ✅ Allowed                  | ✅ [Here](https://github.com/AlphastT101/luminaryai)               | [alphast101](https://alphast101.netlify.app) | [Models](http://api.xet.one/v1/models)                  | [Conducted a coordinated raid on another AI API server.](https://rentry.co/progptraid)                                    |
...
| ---------------------------------------------- | -------------------------- | --------------- | ---------------- | ----------------------------------------- | --------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [AnyAI](https://discord.gg/anyai)              | 1,839                      | ✅ Allowed      | ❌               | [Meow18838](https://github.com/meow18838) | [Models](https://api.airforce/models)         | Most influential person in the server is [a terrible being.](https://api.shard-ai.xyz/sites/meow)                                                       |
...
> [!IMPORTANT]  
> Data given without warranty of any kind. **As of January 2025.**
